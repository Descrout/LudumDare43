...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Adil Basar", "ludumdare43", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "ludumdare43";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "ludumdare43", null, { width: 640, height: 480 });
