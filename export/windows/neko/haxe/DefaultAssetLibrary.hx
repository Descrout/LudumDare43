...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/batCage.png", "assets/images/batCage.png");
		type.set ("assets/images/batCage.png", AssetType.IMAGE);
		path.set ("assets/images/bullet.png", "assets/images/bullet.png");
		type.set ("assets/images/bullet.png", AssetType.IMAGE);
		path.set ("assets/images/crab.png", "assets/images/crab.png");
		type.set ("assets/images/crab.png", AssetType.IMAGE);
		...
		path.set ("assets/images/hitSpark.png", "assets/images/hitSpark.png");
		type.set ("assets/images/hitSpark.png", AssetType.IMAGE);
		path.set ("assets/images/images-go-here.txt", "assets/images/images-go-here.txt");
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		path.set ("assets/images/player.png", "assets/images/player.png");
		type.set ("assets/images/player.png", AssetType.IMAGE);
		path.set ("assets/images/playerIdle.png", "assets/images/playerIdle.png");
		type.set ("assets/images/playerIdle.png", AssetType.IMAGE);
		...
		id = "assets/images/batCage.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/bullet.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/crab.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/playerIdle.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
