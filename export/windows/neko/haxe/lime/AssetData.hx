...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/batCage.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/crab.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/hitSpark.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/playerIdle.png", Reflect.field (AssetType, "image".toUpperCase ()));
