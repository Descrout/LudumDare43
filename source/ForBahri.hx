...
class ForBahri 
{
	...
	public static inline var playerFireRate = 1 / 5;
	
	public static inline var maxBullet = 60;
	...
	public static inline var crabKnockbackResistanceX = 5;
	public static inline var crabKnockbackResistanceY = 0;
}